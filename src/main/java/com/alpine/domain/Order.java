...
public class Order {
    ...
    private Date shippingDate; // Date when the order was shipped
    private String shippingMethod; // Shipping method used for the order
    private String orderStatus; // Current status of the order
    private BigDecimal orderTotal; // Total amount for the order
