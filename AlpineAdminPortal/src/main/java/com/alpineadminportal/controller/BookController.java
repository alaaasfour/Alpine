package com.alpineadminportal.controller;
...
public class BookController {
    ...
    public String addBookPost(
        ...
        try {
            ...
            BufferedOutputStream stream = new BufferedOutputStream(new FileOutputStream(new File("src/main/resources/static/images/books/" + name)));
            stream.write(bytes);
            stream.close();
        } catch (Exception e) {
            e.printStackTrace();
